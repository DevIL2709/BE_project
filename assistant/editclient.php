      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand">Update Client Details</a>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-4 col-lg-2 form-group">
                        ...
                        <input type="text" class="form-control" name="alternateno" pattern="[0-9]{10}" value="<?php echo $array['alternateno'] ?>">
                      </div>
...
if(isset($_SESSION['assistant']) && $_SESSION['assistant']==true) {
    require_once "../functions/database_functions.php";
      if(isset($_POST['submit'])) {
          ...
          $query = "UPDATE clients SET oname='$oname', oemail='$oemail', website='$website', name='$username', gender='$gender', email='$email', mobno='$mobno', alternateno='$alternateno', address='$address', assto='$assto' WHERE ID='$id'";
          $result = mysqli_query($conn, $query);
