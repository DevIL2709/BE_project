                  ...
                  <form method="post" action="<?=$_SERVER['PHP_SELF'];?>">
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="in" class="text-primary pl-3">Name</label>
                        <input type="text" class="form-control" name="in">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="expense" class="text-primary pl-3">Expense</label>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="note" class="text-primary pl-3">Note</label>
