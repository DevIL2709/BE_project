      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand">Update Expense</a>
          </div>
                  ...
                  <form method="post" action="<?=$_SERVER['PHP_SELF'];?>">
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="in" class="text-primary pl-3 pl-3">Name</label>
                        <input type="text" class="form-control" name="in" value="<?php echo $array['name'] ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="expense" class="text-primary pl-3 pl-3">Expense</label>
                        <input type="text" class="form-control" name="expense" value="<?php echo $array['expense'] ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="date" class="text-primary pl-3 pl-3">Date</label>
                        <input type="date" class="form-control" name="date" value="<?php echo $array['date'] ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 col-lg-3 form-group">
                        <label for="note" class="text-primary pl-3 pl-3">Note</label>
                        <input type="textarea" class="form-control" name="note" value="<?php echo $array['note'] ?>">
                      </div>
                    </div>
...
if(isset($_POST['submit'])) {
  ...
  $query = "UPDATE expense SET name='$in', expense='$expense', date='$date', note='$note' WHERE ID='$id';";
  $result = mysqli_query($conn, $query);
