                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div class="d-flex justify-content-center">
                      <form method="post" action="./exppdf.php" target="_blank">
                      <div class="row">
                      <div class="form-group">
                        <label for="startdate" class="ml-3 mt-3 text-primary">From: </label>
                        <input type="date" class="form-control mt-3 ml-3" name="startdate" id="startdate">
                      </div>
                      </div>
                      <div class="row">
                      <div class="form-group">
                        <label for="enddate" class="ml-3 mt-3 text-primary">To: </label>
                        <input type="date" class="form-control mt-3 ml-3" name="enddate" id="enddate">
                      </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <?php while($array = mysqli_fetch_assoc($result)): ?>
                      <tr>
                        ...
                        <td><?php echo "₹ ".$array['expense']; ?></td>
                        <td><?php echo $array['date']; ?></td>
                        <td><?php echo $array['note']; ?></td>
